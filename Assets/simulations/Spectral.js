...
const SpectralSensors = () => {
  ...
  const modes = {
    pan: {
      ...
      description:
        "Un singolo sensore cattura l'intensità totale della luce. Ottieni un'immagine in bianco e nero estremamente nitida (alta risoluzione spaziale), ideale per vedere strade, edifici e confini.",
    ...
    multi: {
      ...
      description:
        "Cattura colori reali e infrarosso vicino. La risoluzione spaziale è inferiore (immagine più 'granulosa' del PAN), ma puoi distinguere la vegetazione dall'acqua e dal suolo nudo.",
    ...
    hyper: {
      ...
      description:
        "Permette di identificare la chimica dei materiali. Quello che sembrava un semplice campo verde (Multi) ora rivela zone di stress idrico o tipi di piante diverse (visualizzate in falsi colori).",
        ...
        <div className="flex-1 flex flex-col gap-6">
          ...
          <div className="bg-slate-800/50 rounded-lg p-6 border border-slate-700">
            ...
            <p className="text-xs text-slate-400 mt-3 italic text-center">
              ${mode === 'pan'
                ? 'Nota la nitidezza delle linee (Strade, confini)'
                : mode === 'multi'
                ? 'I colori aiutano l\'occhio umano, ma la risoluzione cala'
          ...
          >
            ...
            <div className="space-y-3 mt-6 text-sm">
              ...
              <div className="flex items-center justify-between border-b border-slate-700 pb-2">
                ...
                <span
                  className=${`font-mono font-bold ${
                    currentInfo.resolution === 'Alta'
                      ? 'text-green-400'
                      : currentInfo.resolution === 'Media'
                      ? 'text-yellow-400'
                      : 'text-orange-400'
                  }`}
                >
              ...
              <div className="flex items-center justify-between border-b border-slate-700 pb-2">
                ...
                <span
                  className=${`font-mono font-bold ${
                    currentInfo.spectralRes === 'Altissima' ? 'text-green-400' : 'text-slate-300'
                  }`}
                >
