...
The result indicates how much the atmosphere and dead fuel<span class="inline-note"><button type="button" class="inline-note__trigger" aria-label="What is dead fuel?"><span aria-hidden="true">?</span></button><span class="inline-note__popup"><strong>Dead fuel</strong> is vegetation with no living tissue, such as fallen leaves, needles, dry grass, twigs, and wood on the ground. Its moisture is governed almost entirely by relative humidity and precipitation, so fine material changes moisture much faster than large material. <a href="https://www.nwcg.gov/publications/pms205/nwcg-glossary-of-wildland-fire-pms-205/dead-fuels-3">Source: NWCG, Glossary of Wildland Fire</a>; <a href="https://www.nwcg.gov/publications/pms425-1/11-weather-and-fuel-moisture">NWCG guidance on weather and fuel moisture</a>.</span></span> favor ignition and difficult-to-control behavior, should an ignition occur.
...
*The Hellenic Fire System’s first thermal image of Greek territory. Source: ESA.*

Remote sensing can also estimate how ready fuel is to burn. A continental-scale experiment combined ground observations, weather models, and VIIRS reflectances: removing satellite data significantly worsened the error in estimating dead fuel<span class="inline-note"><button type="button" class="inline-note__trigger" aria-label="What is dead fuel?"><span aria-hidden="true">?</span></button><span class="inline-note__popup"><strong>Dead fuel</strong> is vegetation with no living tissue, such as fallen leaves, needles, dry grass, twigs, and wood on the ground. Its moisture is governed almost entirely by relative humidity and precipitation, so fine material changes moisture much faster than large material. <a href="https://www.nwcg.gov/publications/pms205/nwcg-glossary-of-wildland-fire-pms-205/dead-fuels-3">Source: NWCG, Glossary of Wildland Fire</a>; <a href="https://www.nwcg.gov/publications/pms425-1/11-weather-and-fuel-moisture">NWCG guidance on weather and fuel moisture</a>.</span></span> [moisture](https://www.mdpi.com/2072-4292/15/13/3372). At a much finer scale, experimental work in Harbin used 5,945 multispectral drone images and 480 samples: the ConvNeXt model estimated dead fuel<span class="inline-note"><button type="button" class="inline-note__trigger" aria-label="What is dead fuel?"><span aria-hidden="true">?</span></button><span class="inline-note__popup"><strong>Dead fuel</strong> is vegetation with no living tissue, such as fallen leaves, needles, dry grass, twigs, and wood on the ground. Its moisture is governed almost entirely by relative humidity and precipitation, so fine material changes moisture much faster than large material. <a href="https://www.nwcg.gov/publications/pms205/nwcg-glossary-of-wildland-fire-pms-205/dead-fuels-3">Source: NWCG, Glossary of Wildland Fire</a>; <a href="https://www.nwcg.gov/publications/pms425-1/11-weather-and-fuel-moisture">NWCG guidance on weather and fuel moisture</a>.</span></span> [moisture with a MAE of 1.54% on the test set](https://www.mdpi.com/1999-4907/14/9/1724). This is a local test, not a guarantee of transferability; however, it shows how satellites, drones, and ground sampling can occupy different rungs on the same observational ladder.
